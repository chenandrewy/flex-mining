...
#
# How to run: source after 0_Environment.R from Appendix SA01.
# Inputs: published-return panels and factor columns supplied to each function.
# Outputs: in-memory implied-risk shares and category identifiers.
