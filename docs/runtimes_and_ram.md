...
| ↳ `2b_MatchDataMinedToPub.R`        |              ~4 min | Writes `MatchPub.RData`; pairwise published/mined correlations are already retained in `dmcomp_sumstats.RDS`.                                                                                                                                                                                  |
...
| ↳ `3d_MatchedUncorrData.R`          |             **~13 s** | Measured after migrating its signed-correlation input to `dmcomp_sumstats.RDS`; writes the canonical matched-uncorrelated benchmark.                                                                                                                                                             |
