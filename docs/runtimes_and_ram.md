...
| ↳ `3d_MatchedUncorrData.R`          |             **~17 s** | Materializes selected pair-month returns on demand from `LongShort.RData`; writes the canonical matched-uncorrelated benchmark.                                                                                                                                                                 |
