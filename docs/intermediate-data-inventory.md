...
Last verified: 2026-08-15 20:52 EDT
...
sizes. The directory currently contains 33 files totaling 4.56 GB (4.25 GiB).
...
| plotdat0.RDS                              | 66 MB  | 3a_PrepDMBenchmarks.R      | No live reader; generated byproduct |
...
| dm_pca_span_classification.RDS            | 230 MB | 3f_DMSpanPCA.R             | No live reader; generated byproduct |
...
The completed cleanup removed about 967 MB of old-version, coefficient, and
retired top-N artifacts. The clearest remaining generated files with no live
reader are `plotdat0.RDS` (66 MB) and `dm_pca_span_classification.RDS` (230 MB),
for about 296 MB total. Removing them permanently also requires removing or
changing their producer writes; otherwise the next chapter-3 run recreates
them.
