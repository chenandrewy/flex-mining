...
Last verified: 2026-08-15 23:18 EDT
...
directory currently contains 28 files totaling 3.18 GB (2.96 GiB).
...
benchmark metadata. `3e_FactorAdjustedDMPrep.R` writes the risk-adjusted
benchmark cache.

The in-memory matched-uncorrelated universe contains 12,666 retained pairs
across 137 predictors. The separately specified risk-adjusted benchmark
contains 57,173 CAPM-eligible and 47,603 FF4-eligible pairs.
...
The completed cleanup removed about 1.91 GB of old-version, broad matching,
