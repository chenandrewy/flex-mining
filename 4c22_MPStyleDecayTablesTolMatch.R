# Tables 3-4 under the tolerance-matched DM benchmark, for the Aug 13
# "one matching spec for Figures 2 and Tables 3-4" decision. Two specs:
...
#
# Outputs: ../Results/TolMatch/Table_MPStyleRegs{Main,MainUnscaled}_{Tol30,Tol10}.tex
